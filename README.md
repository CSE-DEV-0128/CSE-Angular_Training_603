# Angular Boot Camp example: ngrx-effects
...
**[StackBlitz for ngrx-effects](https://stackblitz.io/github/AngularBootCamp/ngrx-effects)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/ngrx-effects.git
cd ngrx-effects
npm install
npm start
```
